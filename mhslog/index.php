  ...
  if($_SESSION['status'] != "user"){
    echo "<script>window.alert('anda belum login'); window.location=('../proses.php?aksi=login')</script>";
  }
  ?>
<!DOCTYPE html>
<html>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="../uploads/foto/<?php echo"$_SESSION[foto]";?>" class="img-circle" alt="User Image">
            </div>
