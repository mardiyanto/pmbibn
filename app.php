...
while ($t=mysqli_fetch_array($tebaru)){	?>
                    <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item text-center rounded p-4">
                            <div class="service-icon d-inline-block  rounded p-4 mb-4"><i class="fas <?php echo" $t[icon] "; ?> fa-5x text-secondary"></i></div>
                            <div class="service-content">
                                <h4 class="mb-4"><?php echo" $t[nama_menu] "; ?></h4>
                                  <a href="<?php echo" $t[link] "; ?>" class="btn btn-primary  py-2 px-4">Read More</a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
